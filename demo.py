...
## Creating the a training and y training ###
...
# receive X shape: NxP, Y shape: 1xP
linear_regression.fit(x_train, y_train, solver='SGD', epochs=500) 

### making the line regresion ###
x_vector = np.array([[0, 1]])  # create points between 0 and 1, dimension: 1xP
